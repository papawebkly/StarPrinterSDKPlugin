...
/**
 *  This function prints UTF-8 text to the print.  It show how the text can be formated.  For example changing its size.
 *
 *  @param  portName        Port name to use for communication. This should be (TCP:<IP Address>), (BT:<iOS Port Name>),
 *                          or (BLE:<Device Name>).
 *  @param  portSettings    Set following settings
 ...
 *                          - Portable Printer (Star Line Mode)  : @"portable"
 *                          - Others                             : @"" (blank)
 *  @param  ambiguity       The segment index of ambiguous character priority that Tells the printer to weather
 *                          Single-bytes or Double-bytes.
 *  @param  slashedZero     boolean variable to tell the printer to weather to put a slash in the zero characters that
 *                          it print
 *  @param  underline       boolean variable that Tells the printer if should underline the text
 *  @param  invertColor     boolean variable that tells the printer if it should invert the text its printing.  All
                     ...
                     textDataSize:(unsigned int)textDataSize
{
    ...
    unsigned char utf8[] = {0x1b, 0x1d, 0x74, 0x80};
    [commands appendBytes:utf8 length:4];
    
    unsigned char ambiguityChar[] = {0x1b, 0x1d, 0x29, 0x55, 0x02, 0x00, 0x40, 0x00};
    if (ambiguity == 0)
    {
        ambiguityChar[7] = 0x00;
    }
    else if (ambiguity == 1)
    {
        ambiguityChar[7] = 0x01;
    }
    [commands appendBytes:ambiguityChar length:8];
...
/*!
 *  Sample Receipt UTF-8 3inch
 */
+ (NSData *)englishUtf83inchSampleReceipt
{
    const NSStringEncoding ENCODING = NSUTF8StringEncoding;
    
    NSMutableData *commands = [NSMutableData data];
    
    [commands appendBytes:"\x1b\x1d\x74\x80" length:sizeof("\x1b\x1d\x74\x80") - 1]; // UTF-8
    ...
    [commands appendData:[@"Date: MM/DD/YYYY" dataUsingEncoding:ENCODING]];
    ...
    [commands appendData:[@"SKU " dataUsingEncoding:ENCODING]];
    ...
    [commands appendData:[@"Total" dataUsingEncoding:ENCODING]];
...
+ (NSData *)frenchUtf83inchSampleReceipt
{
    const NSStringEncoding ENCODING = NSUTF8StringEncoding;
...
+ (NSData *)portugueseUtf83inchSampleReceipt
{
    const NSStringEncoding ENCODING = NSUTF8StringEncoding;
...
+ (NSData *)spanishUtf83inchSampleReceipt
{
    const NSStringEncoding ENCODING = NSUTF8StringEncoding;
...
+ (NSData *)russianUtf83inchSampleReceipt
{
    const NSStringEncoding ENCODING = NSUTF8StringEncoding;
...
/*!
 *  Japanese Sample Receipt UTF-8 (3inch)
 */
+ (NSData *)japaneseUtf83inchSampleReceipt
{
    const NSStringEncoding ENCODING = NSUTF8StringEncoding;
    ...
    [commands appendBytes:"\x1b\x1d\x74\x80"
                   length:sizeof("\x1b\x1d\x74\x80") - 1];    // UTF-8
...
/**
 *  Japanese sample receipt UTF-8 (4inch)
 */
+ (NSData *)japaneseUtf84inchSampleReceipt
{
    const NSStringEncoding ENCODING = NSUTF8StringEncoding;
...
/**
 *  Simplified Chinese Sample Receipt UTF-8 (3inch)
 */
+ (NSData *)simplifiedChineseUtf83inchSampleReceipt
{
    const NSStringEncoding ENCODING = NSUTF8StringEncoding;
...
/**
 *  Simplified Chinese Sample Receipt UTF-8 (4inch)
 */
+ (NSData *)simplifiedChineseUtf84inchSampleReceipt
{
    const NSStringEncoding ENCODING = NSUTF8StringEncoding;
...
/**
 *  Traditional Chinese Sample Receipt UTF-8 (3inch)
 */
+ (NSData *)traditionalChineseUtf83inchSampleReceipt
{
    const NSStringEncoding ENCODING = NSUTF8StringEncoding;
...
+ (NSData *)sampleReceiptWithPaperWidth:(SMPaperWidth)paperWidth
                               language:(SMLanguage)language
                             kickDrawer:(BOOL)kickDrawer
{
    ...
    switch (language) {
        case SMLanguageEnglish:
            ...
            break;
        case SMLanguageEnglishUtf8:
            languageName = @"englishUtf8";
            break;
        case SMLanguageFrench:
            languageName = @"french";
            break;
        case SMLanguageFrenchUtf8:
            languageName = @"frenchUtf8";
            break;
        case SMLanguagePortuguese:
            languageName = @"portuguese";
            break;
        case SMLanguagePortugueseUtf8:
            languageName = @"portugueseUtf8";
            break;
        case SMLanguageSpanish:
            languageName = @"spanish";
            break;
        case SMLanguageSpanishUtf8:
            languageName = @"spanishUtf8";
            break;
        case SMLanguageRussian:
            languageName = @"russian";
            break;
        case SMLanguageRussianUtf8:
            languageName = @"russianUtf8";
            break;
        case SMLanguageJapanese:
            languageName = @"japanese";
            break;
        case SMLanguageJapaneseUtf8:
            languageName = @"japaneseUtf8";
            break;
        case SMLanguageSimplifiedChinese:
            languageName = @"simplifiedChinese";
            break;
        case SMLanguageSimplifiedChineseUtf8:
            languageName = @"simplifiedChineseUtf8";
            break;
        case SMLanguageTraditionalChinese:
            languageName = @"traditionalChinese";
            break;
        case SMLanguageTraditionalChineseUtf8:
            languageName = @"traditionalChineseUtf8";
            break;
    }
    ...
    // Get receipt data
    NSData *receiptData = [[self performSelector:selector] retain];
                       ...
                       width:(CGFloat)width
{
    ...
    CGSize messuredSize = [string boundingRectWithSize:size
...
+ (void)PrintRasterSampleReceiptWithPortname:(NSString *)portName
                                portSettings:(NSString *)portSettings
                                  paperWidth:(SMPaperWidth)paperWidth
                                    Language:(SMLanguage)language
{
    UIImage *imageToPrint = [[self rasterSampleReceiptImageWithLanguage:language paperWidth:paperWidth] retain];
    if (!imageToPrint) {
    ...
    // AllReceipt Authentication. (if needed)

    // Upload Image to AllReceipt service.
    [imageToPrint release];
}

+ (UIImage *)rasterSampleReceiptImageWithLanguage:(SMLanguage)language
                                       paperWidth:(SMPaperWidth)paperWidth {
    UIImage *image = nil;
    ...
    switch (language) {
        case SMLanguageEnglish:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    image = [self english2inchRasterSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    image = [self english3inchRasterSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    image = [self english4inchRasterSampleReceipt];
                    break;
            }
            break;
        case SMLanguageFrench:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    image = [self french2inchRasterSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    image = [self french3inchRasterSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    image = [self french4inchRasterSampleReceipt];
                    break;
            }
            break;
        case SMLanguagePortuguese:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    image = [self portuguese2inchRasterSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    image = [self portuguese3inchRasterSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    image = [self portuguese4inchRasterSampleReceipt];
                    break;
            }
            break;
        case SMLanguageSpanish:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    image = [self spanish2inchRasterSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    image = [self spanish3inchRasterSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    image = [self spanish4inchRasterSampleReceipt];
                    break;
            }
            break;
        case SMLanguageRussian:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    image = [self russian2inchRasterSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    image = [self russian3inchRasterSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    image = [self russian4inchRasterSampleReceipt];
                    break;
            }
            break;
        case SMLanguageJapanese:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    image = [self kanji2inchRasterSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    image = [self kanji3inchRasterSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    image = [self kanji4inchRasterSampleReceipt];
                    break;
            }
            break;
        case SMLanguageSimplifiedChinese:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    image = [self simplifiedChinese2inchRasterSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    image = [self simplifiedChinese3inchRasterSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    image = [self simplifiedChinese4inchRasterSampleReceipt];
                    break;
            }
            break;
        case SMLanguageTraditionalChinese:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    image = [self traditionalChinese2inchRasterSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    image = [self traditionalChinese3inchRasterSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    image = [self traditionalChinese4inchRasterSampleReceipt];
                    break;
            }
            break;
        default:
...
/**
 *  Create raster sample receipt image. (2inch)
 */
+ (UIImage *)english2inchRasterSampleReceipt {
...
/**
 *  Create raster sample receipt image. (3inch)
 */
+ (UIImage *)english3inchRasterSampleReceipt {
    NSString *textToPrint = @"        Star Clothing Boutique\r\n"
                             "             123 Star Road\r\n"
                             "           City, State 12345\r\n"
                             "\r\n"
...
/**
 *  Create raster sample receipt image. (4inch)
 */
+ (UIImage *)english4inchRasterSampleReceipt {
    NSString *textToPrint = @"                   Star Clothing Boutique\r\n"
                             "                        123 Star Road\r\n"
                             "                      City, State 12345\r\n"
                             "\r\n" 
...
/**
 *  Create Raster French sample receipt image (2inch)
 */
+ (UIImage *)french2inchRasterSampleReceipt {
...
/**
 *  Create Raster French sample receipt image. (3inch)
 */
+ (UIImage *)french3inchRasterSampleReceipt {
    NSString *textToPrint = @"                ORANGE                \n"
                             "           36 AVENUE LA MOTTE         \n"
                             "        PICQUET City, State 12345     \n\n"
                             "--------------------------------------\n"
...
/**
 *  Create Raster French sample receipt image. (4inch)
 */
+ (UIImage *)french4inchRasterSampleReceipt {
    NSString *textToPrint = @"                        ORANGE                         \n"
...
/**
 *  This function create the Raster Portuguese sample receipt image. (2inch)
 */
+ (UIImage *)portuguese2inchRasterSampleReceipt {
...
/**
 *  This function create the Raster Portuguese sample receipt image. (3inch)
 */
+ (UIImage *)portuguese3inchRasterSampleReceipt {
    NSString *textToPrint = @"         COMERCIAL DE ALIMENTOS        \n"
                             "            CARREFOUR LTDA.            \n"
                             "        Avenida Moyses Roysen,         \n"
                             "          S/N Vila Guilherme           \n"
...
/**
 * This function create the Raster Portuguese sample receipt image. (4inch)
 */
+ (UIImage *)portuguese4inchRasterSampleReceipt {
...
/**
 *  This function create the Raster Spanish sample receipt image. (2inch)
 */
+ (UIImage *)spanish2inchRasterSampleReceipt {
 ...
 */
+ (UIImage *)spanish3inchRasterSampleReceipt {
    NSString *textToPrint =  @"                        BAR RESTAURANT\n"
                              "                               EL POZO\n"
                              "C/.ROCAFORT 187                       \n"
                              "08029 BARCELONA                       \n"
...
/**
 *  This function create the Raster Spanish sample receipt image. (4inch)
 */
+ (UIImage *)spanish4inchRasterSampleReceipt {
...
/**
 *  This function create the Raster Russian sample receipt image. (2inch)
 */
+ (UIImage *)russian2inchRasterSampleReceipt {
...
/**
 *  This function create the Raster Russian sample receipt image. (3inch)
 */
+ (UIImage *)russian3inchRasterSampleReceipt {
...
/**
 *  This function create the Raster Russian sample receipt image. (4inch)
 */
+ (UIImage *)russian4inchRasterSampleReceipt {
    NSString *textToPrint = @"               Р Е Л А К С   ООО “РЕЛАКС”            \n"
                             "                СПб., Малая Балканская, д. 38, лит. А\n\n"
                             "тел. 307-07-12                                       \n"
                             "РЕГ №322736     ИНН:123321                           \n"
...
/**
 *  This function create the Raster Kanji sample receipt image. (2inch)
 */
+ (UIImage *)kanji2inchRasterSampleReceipt {
    char *sjisText = "　　　　　　スター電機\n"
                     "　　　　修理報告書　兼領収書\n"
                     "------------------------------------------------\r\n"
    ...
    if (font == nil) {
        font = [UIFont fontWithName:@"HiraKakuProN-W3" size:(11.0 * 2)];
    }
 ...
 */
+ (UIImage *)kanji3inchRasterSampleReceipt {
    char *sjisText = "　　　　　　　　　　スター電機\n"
                     "　　　　　　　　修理報告書　兼領収書\n"
                     "-------------------------------------------------------------------\r\n"
                     "発行日時：YYYY年MM月DD日HH時MM分\n"
    ...
    if (font == nil) {
        font = [UIFont fontWithName:@"HiraKakuProN-W3" size:(12.0 * 2)];
    }
...
/**
 *  This function create the Raster Kanji sample receipt image. (4inch)
 */
+ (UIImage *)kanji4inchRasterSampleReceipt {
    char *sjisText = "　　　　　　　　　　　　　　　スター電機\n"
                     "　　　　　　　　　　　　　修理報告書　兼領収書\n"
                     "------------------------------------------------------------------------------------------------\r\n"
                     "発行日時：YYYY年MM月DD日HH時MM分\n"
...
/**
 *  This function create the Raster Simplified Chainese sample receipt image. (2inch)
 */
+ (UIImage *)simplifiedChinese2inchRasterSampleReceipt {
...
/**
 *  This function craete the Raster Simplified Chainese sample receipt image. (3inch)
 */
+ (UIImage *)simplifiedChinese3inchRasterSampleReceipt {
    char *gb2312Text = "　　　　　　  　　STAR便利店\n"
                       "                欢迎光临\n"
                       "\n"
                       "Unit 1906-08,19/F,Enterprise Square 2,\n"
...
/**
 *  This function create the Raster Simplified Chainese sample receipt image. (4inch)
 */
+ (UIImage *)simplifiedChinese4inchRasterSampleReceipt {
    char *gb2312Text = "　　　　　　  　　         STAR便利店\n"
                       "                          欢迎光临\n"
                       "\n"
                       "     Unit 1906-08,19/F,Enterprise Square 2,\n"
...
/**
 *  This function create the Raster Traditional Chainese sample receipt image. (3inch)
 */
+ (UIImage *)traditionalChinese2inchRasterSampleReceipt {
 ...
 */
+ (UIImage *)traditionalChinese3inchRasterSampleReceipt {
    char *gig5Text = "　 　　　  　　Star Micronics\n"
                     "---------------------------------------\r\n"
                     "              電子發票證明聯\n"
                     "              103年01-02月\n"
...
/**
 *  This function create the Raster Traditional Chainese sample receipt image. (4inch)
 */
+ (UIImage *)traditionalChinese4inchRasterSampleReceipt {
    char *gig5Text = "　 　　　  　  　       Star Micronics\n"
                     "---------------------------------------------------------\r\n"
                     "                       電子發票證明聯\n"
                     "                       103年01-02月\n"
...
+ (void)printSampleReceiptWithoutDrawerKickWithPortname:(NSString *)portName
    ...
    NSData *commands = [[self sampleReceiptWithPaperWidth:paperWidth language:SMLanguageEnglish kickDrawer:NO] retain];
