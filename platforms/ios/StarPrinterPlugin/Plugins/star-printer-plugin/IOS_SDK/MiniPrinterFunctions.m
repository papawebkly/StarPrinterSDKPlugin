...
+ (void)printSampleReceiptWithPortname:(NSString *)portName portSettings:(NSString *)portSettings paperWidth:(SMPaperWidth)paperWidth language:(SMLanguage)language {
    ...
    NSData *commands = [[self performSelector:sel] retain];
...
+ (NSData *)sampleReceiptDataWithLanguage:(SMLanguage)language
    ...
    switch (language) {
        case SMLanguageEnglish:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    data = [self english2inchSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    data = [self english3inchSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    data = [self english4inchSampleReceipt];
                    break;
            }
            break;
        case SMLanguageFrench:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    data = [self french2inchSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    data = [self french3inchSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    data = [self french4inchSampleReceipt];
                    break;
            }
            break;
        case SMLanguagePortuguese:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    data = [self portuguese2inchSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    data = [self portuguese3inchSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    data = [self portuguese4inchSampleReceipt];
                    break;
            }
            break;
        case SMLanguageSpanish:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    data = [self spanish2inchSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    data = [self spanish3inchSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    data = [self spanish4inchSampleReceipt];
                    break;
            }
            break;
        case SMLanguageJapanese:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    data = [self japanese2inchSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    data = [self japanese3inchSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    data = [self japanese4inchSampleReceipt];
                    break;
            }
            break;
        case SMLanguageTraditionalChinese:
            switch (paperWidth) {
                case SMPaperWidth2inch:
                    data = [self traditionalChinese2inchSampleReceipt];
                    break;
                case SMPaperWidth3inch:
                    data = [self traditionalChinese3inchSampleReceipt];
                    break;
                case SMPaperWidth4inch:
                    data = [self traditionalChinese4inchSampleReceipt];
                    break;
            }
            break;
        default:
